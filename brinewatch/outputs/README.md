...
| [localization/v2_run1/](localization/v2_run1/) — **FINAL** localization study: pose-matched background subtraction, 4 independent acquisitions, median error 2.28 m, fallback 0 | custom fork | fork test level | FINAL localization evidence |
...
| [full_mission/custom_run1/](full_mission/custom_run1/) — **FINAL** custom-engine scientific mission: native simulated sonar LOCATE of the spawned outfall (no GT) + kinematic survey / GP map / screening anchored at the estimate; summary.json, report.html, maps, sonar frames | custom fork (LOCATE) + kinematic (survey) | ExampleLevel | FINAL mission |
