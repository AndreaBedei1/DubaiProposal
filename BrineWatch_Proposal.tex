...
BrineWatch turns a \$5k-class open-source ROV --- a \keyword{BlueROV2 Heavy} with low-light HD camera, side-scan sonar (Cerulean Omniscan SS450) and IMU --- plus a ${\approx}$\texteuro300 \keyword{conductivity--temperature payload} (I\textsuperscript{2}C on BlueOS) into an autonomous compliance instrument (Fig.~\ref{fig:concept}):
\begin{enumerate}
